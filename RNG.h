...
class RNG {
 ...
 public:
    RNG (bool randSeed, unsigned int seed, int numagents, int numcom, double shockmin, double shockmax, double minalpha, double maxalpha, double minwealth, double maxwealth);
