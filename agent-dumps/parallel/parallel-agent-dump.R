...
fixed<-read_csv("~/c/exchange/agent-dumps/parallel/fixedactivations.csv",col_names=F)
fixed <- dplyr::rename(fixed, id=X1, activations=X2, trades=X3)
fixed$type = "Fixed"
random<-read_csv("~/c/exchange/agent-dumps/parallel/randomactivations.csv",col_names=F)
random <- dplyr::rename(random, id=X1, activations=X2, trades=X3)
random$type = "Random"
uniform<-read_csv("~/c/exchange/agent-dumps/parallel/uniformactivations.csv",col_names=F)
...
poisson2<-read_csv("~/c/exchange/agent-dumps/parallel/poisson2activations.csv",col_names=F)
poisson2 <- dplyr::rename(poisson2, id=X1, activations=X2, trades=X3)
poisson2$type = "Poisson-Poor"
poisson3<-read_csv("~/c/exchange/agent-dumps/parallel/poisson3activations.csv",col_names=F)
poisson3 <- dplyr::rename(poisson3, id=X1, activations=X2, trades=X3)
poisson3$type = "Poisson-Rich"
poisson4<-read_csv("~/c/exchange/agent-dumps/parallel/poisson4activations.csv",col_names=F)
...
ggsave("parallel-agent-dump-histogram.pdf", p, width = 6.2, height = 3, units = "in")
ggsave("parallel-agent-dump-histogram2.pdf", p2, width = 6.2, height = 3, units = "in")
ggsave("parallel-agent-dump-histogram3.pdf", p3, width = 6.2, height = 3, units = "in")
ggsave("parallel-agent-dump-histogram4.pdf", p4, width = 6.2, height = 3, units = "in")
